...
#'
#' @param x a contingency table or a vector. If a vector, passed to \code{\link[base]{table}}.
#' @param base base of the logarithm to be used. Default is exp(1), natural.
#' Base 2 and base 10 are also common.
#' @param ... if x is a vector, further arguments to be passed on to \code{\link[base]{table}}.
#'
#' @details
